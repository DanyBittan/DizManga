 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Comic> $MyBooks
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Comic> $Wishlist
...
class User extends Authenticatable
{
    ...
    {
        return $this->belongsToMany(Comic::class, "wishlists", "user_id", "comic_id");
    }
    ...
    {
        return $this->belongsToMany(Comic::class, "my_books", "user_id", "comic_id");
    }
}
